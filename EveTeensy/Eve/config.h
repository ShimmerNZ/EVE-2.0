...
#include "graphics/EveEye.h"      // Standard human-ish hazel eye -OR-
...
eyeInfo_t eyeInfo[] = {
  ...
  { 11, 2, 0 }, // RIGHT EYE display-select and wink pins, no rotation
#endif
};
...
// DISPLAY HARDWARE SETTINGS (screen type & connections) -------------------
  ...
  //#include <Adafruit_ST7735.h>  // TFT display library (enable one only)
    ...
    #define DISPLAY_RESET    9  // Reset pin for ALL displays
  #endif
#endif
